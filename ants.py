    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                else:# self.ant.is_container == False | insect.is_container == False:                # BEGIN Problem 9
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        ind = 0
        some_place = self.place
        while some_place != hive:
            if self.min_range <= ind and ind <= self.max_range:
                if random_or_none(some_place.bees):
                    return random_or_none(some_place.bees)
            ind += 1
            some_place = some_place.entrance
        # END Problem 3 and 4
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        for impostor in self.queens[1:]:
            impostor.reduce_armor(impostor.armor)
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        self.armor -= amount
        if self.true_queen == True and self.armor <= 0:
            bees_win()
        # END Problem 13
